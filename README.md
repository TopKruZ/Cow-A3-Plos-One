...
Code -> The repository provides the complete implementation, including the standard training pipeline, the targeted fine-tuning script, and the scripts for evaluating performance metrics. This includes the calculation of per-class F1-scores using real-world test data captured on an unseen day to validate the model's robustness in practical environments.
